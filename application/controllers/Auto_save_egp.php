...
class Auto_save_egp extends CI_Controller
{
    ...
    {
        $json_url = "https://govspending.data.go.th/api/service/cgdcontract?api-key=TH3JFBwJZlaXdDCpcVfSFGuoofCJ1heX&dept_code=5400402&year=2567&limit=500";
    ...
    {
        $json_url = "https://govspending.data.go.th/api/service/cgdcontract?api-key=TH3JFBwJZlaXdDCpcVfSFGuoofCJ1heX&dept_code=5400402&year=2566&limit=500";
    ...
    {
        $json_url = "https://govspending.data.go.th/api/service/cgdcontract?api-key=TH3JFBwJZlaXdDCpcVfSFGuoofCJ1heX&dept_code=5400402&year=2565&limit=500";
    ...
    {
        $json_url = "https://govspending.data.go.th/api/service/cgdcontract?api-key=TH3JFBwJZlaXdDCpcVfSFGuoofCJ1heX&dept_code=5400402&year=2564&limit=500";
    ...
    {
        $json_url = "https://govspending.data.go.th/api/service/cgdcontract?api-key=TH3JFBwJZlaXdDCpcVfSFGuoofCJ1heX&dept_code=5400402&year=2563&limit=500";
