...
<head>
    ...
    <style media="screen">
        ...
        *:after {
        ...
        .bg {
            /* The image used */
            background-image: url('<?php echo base_url("docs/k.bg-select-loginv2.jpg"); ?>');
            /* Full height */
            height: 100vh;
        ...
        <div class="bg">
            <div class="bg-content">
                <div class="text-center mt-4">
                    ...
                    <div class="mt-3">
                        <h2>เทศบาลตำบลดองโมง</h2>
                        <h3>อำเภอหนองเรือง จังหวัดขอนแก่น</h3>
                    </div>
                </div>
