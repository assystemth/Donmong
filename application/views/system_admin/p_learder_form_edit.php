        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('p_learder_backend/edit_p_learder/' . $rsedit->p_learder_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="p_learder_name" class="form-control" value="<?= $rsedit->p_learder_name; ?>">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <a class="btn btn-info" href="#" role="button" onclick="confirmDelete('<?= $rsedit->p_learder_id; ?>');">ลบข้อมูล</a>
                            <script>
