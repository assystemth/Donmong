...
<script>
    ...
    $(document).ready(function() {
        $(".slick-carousel").slick({
            ...
            autoplaySpeed: 5000,
            arrows: true,
            prevArrow: '<img src="docs/d.pre-travel.png" class="slick-prev">',
            nextArrow: '<img src="docs/d.next-travel.png" class="slick-next">'
        });
    });
    ...
    $(document).ready(function() {
        $(".slick-carousel-otop").slick({
            ...
            autoplaySpeed: 5000,
            arrows: true,
            prevArrow: '<img src="docs/d.pre-travel.png" class="slick-prev-otop">',
            nextArrow: '<img src="docs/d.next-travel.png" class="slick-next-otop">',
