            ...
            <script>
                ...
                if (window.innerWidth < 600) {
                    ...
                    if (today >= holiday1Start && today <= holiday1End) {
                        ...
                        specialImage.src = "https://assystem.co.th/Day/Donmong/kid.jpg"; // วันเด็ก
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday2Start && today <= holiday2End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/makabucha.jpg"; // วันมาฆบูชา
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday3Start && today <= holiday3End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/6apr.jpg"; // วันจักรี
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday4Start && today <= holiday4End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/songkran.gif"; // วันสงกรานต์
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday5Start && today <= holiday5End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/4may.jpg"; // วันฉัตรมงคล
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday6Start && today <= holiday6End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/puechmongkol.jpg"; // วันพืชมงคล
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday7Start && today <= holiday7End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/wisakabucha.jpg"; // วันวิสาขบูชา
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday8Start && today <= holiday8End) {
                        document.getElementById("special-image").src = "https://assystem.co.th/Day/Donmong/3june.jpg"; // วันเฉลิมพระชนมพรรษาสมเด็จพระนางเจ้าสุทิดา พัชรสุธาพิมลลักษณ พระบรมราชินี
                        ...
                        document.getElementById("special-image").src = "https://assystem.co.th/Day/Donmong/dad.jpg"; // วันเฉลิมพระชนมพรรษาสมเด็จพระนางเจ้าสุทิดา พัชรสุธาพิมลลักษณ พระบรมราชินี
                        // document.write('<a href="' + '<?= base_url('Home') ?>' + '"><img src="docs/to-web.png" alt="เข้าสู่เว็บไซต์" style="width: 17vw; height: auto; margin: 0 auto; margin-top: 250%;"></a>');
                        document.write('<div style="display: flex; justify-content: space-between; margin-left:33%; ">');
                        ...
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/asarahabucha.jpg"; // วันอาสาฬหบูชา
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday11Start && today <= holiday11End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/kaupunsa.jpg"; // วันเข้าพรรษา
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday12Start && today <= holiday12End) {
                        document.getElementById("special-image").src = "https://assystem.co.th/Day/Donmong/12aug.jpg"; // วันเฉลิมพระชนมพรรษาสมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ พระบรมราชชนนีพันปีหลวง
                        // document.write('<a href="' + '<?= base_url('Home') ?>' + '"><img src="docs/to-web.png" alt="เข้าสู่เว็บไซต์" style="width: 17vw; height: auto; margin: 0 auto; margin-top: 250%;"></a>');
                        document.write('<div style="display: flex; justify-content: space-between; margin-left:33%; ">');
                        document.write('<a target="_blank" href="' + 'https://wellwishes.royaloffice.th/' + ' "style="width: 35vw; height: 30vh; margin: 0 auto; margin-top: 50%;" ></a>');
                        document.write('<a href="' + '<?= base_url('Home') ?>' + '"  style="width: 50vw; height: 30vh; margin: 0 auto; margin-top: 50%; "></a>');
                        ...
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/13oct.jpg"; // วันนวมินทรมหาราช
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday14Start && today <= holiday14End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/23oct.jpg"; // วันปิยมหาราช
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday15Start && today <= holiday15End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/loykratong.jpg"; // วันลอยกระทง
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday16Start && today <= holiday16End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/5dec.jpg"; // วันคล้ายวันพระบรมราชสมภพ พระบาทสมเด็จพระบรมชนกาธิเบศร มหาภูมิพลอดุลยเดชมหาราช บรมนาถบพิตร
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday17Start && today <= holiday17End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/10dec.jpg"; // วันรัฐธรรมนูญ
                        specialImage.addEventListener("click", goToHome);
                    } else if (today >= holiday18Start && today <= holiday18End) {
                        const specialImage = document.getElementById("special-image");
                        specialImage.src = "https://assystem.co.th/Day/Donmong/newyear.jpg"; // วันขึ้นปีใหม่
                        specialImage.addEventListener("click", goToHome);
                    }
                } else {
                    window.location.href = '<?= base_url('Home') ?>';
