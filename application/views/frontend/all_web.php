                ...
                <div class="col-6">
                    <div class="content-all-web">
                        ...
                        <div class="underline pad-left-35 mt-1 mb-1">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/travel'); ?>" class="font-content-all-web">สถานที่สำคัญ</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/award'); ?>" class="font-content-all-web">รางวัลแห่งความภาคภูมิใจ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/msg_pres'); ?>" class="font-content-all-web">สารจากนายก</a><br>
                            <div class="mt-1"></div>
                    ...
                    <div class="content-all-web">
                        ...
                        <div class="underline pad-left-35">
                            ...
                            <a href="<?php echo site_url('Pages/operation_reauf'); ?>" class="font-content-all-web">รายงานติดตามและประเมินผลแผน</a><br>
                            <div class="mt-1"></div>
                            <a class="font-content-all-web">การบริหารและพัฒนาทรัพยากรบุคคล</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_we'); ?>" class="font-content-all-web">งานจริยธรรม</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_spfct'); ?>" class="font-content-all-web">การลดขั้นตอนการปฏิบัติงาน</a><br>
                            <div class="mt-1"></div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35 mt-2 mb-2">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_gbo'); ?>" class="font-content-all-web">คู่มือผลประโยชน์ทับซ้อน</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_ckl'); ?>" class="font-content-all-web">ศูนย์การจัดการความรู้</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_cosr'); ?>" class="font-content-all-web">ศูนย์ปฏิบัติการความปลอดภัยทางถนน</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_hkl'); ?>" class="font-content-all-web">คลังความรู้ / แผ่นพับประชาสัมพันธ์</a><br>
                        </div>
                    </div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35">
                            ...
                            <div class="mt-1"></div>
                            <a href="https://mbdb.cgd.go.th/wel/" target="_blank" class="font-content-all-web">ระบบตรวจสอบสิทธิสวัสดิการ</a><br>
                            <div class="mt-1"></div>
                            <a href="https://csgcheck.dcy.go.th/public/eq/popSubsidy.do?ms=158953" target="_blank" class="font-content-all-web">ระบบตรวจสอบสิทธิผู้มีสิทธิรับเงินอุดหนุนเพื่อการเลี้ยงดูเด็กแรกเกิด</a><br>
                        </div>
                    </div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35">
                            <!-- <a href="<?php echo site_url('Pages/order'); ?>" class="font-content-all-web">ข่าวประชาสัมพันธ์</a><br>
                            <div class="mt-1"></div> -->
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/announce'); ?>" class="font-content-all-web">คู่มือและมาตราฐานการปฏิบัติงาน</a><br>
                            <div class="mt-1"></div>
                ...
                <div class="col-6">
                    <div class="content-all-web">
                        ...
                        <div class="underline pad-left-35 mt-1 mb-1">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_education'); ?>" class="font-content-all-web">กองสาธารณะสุขและสิ่งแวดล้ม</a><br>
                            <div class="mt-1"></div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_sttg'); ?>" class="font-content-all-web">แผนยุทศาสตร์</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_audit'); ?>" class="font-content-all-web">แผนการตรวจสอบภายใน</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_lad'); ?>" class="font-content-all-web">กฏบัตรการตรวจสอบภายใน</a><br>
                        </div>
                    </div>

                    <br><br>
                    <a href="<?php echo site_url('Pages/procurement'); ?>" class="font-head-all-web underline">ข่าวจัดซื้อจัดจ้าง</a><br>
                    <a href="<?php echo site_url('Pages/procurement'); ?>" class="font-head-all-web underline">จัดซื้อจัดจ้าง e-GP</a><br>
                    <a href="<?php echo site_url('Pages/p_reb'); ?>" class="font-head-all-web underline">รายงานใช้จ่ายงบประมาณ</a><br>
                    <a href="<?php echo site_url('Pages/p_rpo'); ?>" class="font-head-all-web underline">รายงานผลการดำเนินการ</a><br>
                    <a href="<?php echo site_url('Pages/news'); ?>" class="font-head-all-web underline">ข่าวประชาสัมพันธ์</a><br>
                    <a href="<?php echo site_url('Pages/announce'); ?>" class="font-head-all-web underline">ประกาศเทศบาล</a><br>
                    <a href="<?php echo site_url('Pages/order'); ?>" class="font-head-all-web underline">คำสั่งเทศบาล</a><br>
                </div>
            </div>
        </div>
    </div>
