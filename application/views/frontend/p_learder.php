<div class="bg-pages ">
    ...
    <div class="page-center">
        <div class="head-pages">
            <span class="font-pages-head-long">ผู้นำชุมชน</span>
        </div>
    </div>
        ...
        <div class="scrollable-container">
            <div class="page-center">
                <?php foreach ($query_one as $rs) { ?>
                    <?php if (!empty($rs->p_learder_rank)) : ?>
                        <div class="bg-personnel-s">
                            <div class="rounded-image-s">
                            <?php if (!empty($rs->p_learder_img)) : ?>
                                        <img src="<?php echo base_url('docs/img/' . $rs->p_learder_img); ?>" width="100%" height="100%">
                                    <?php else : ?>
                        ...
                        <div class="mt-3 center-center">
                            <span class="font-p-name">
                                <?php echo !empty($rs->p_learder_name) ? $rs->p_learder_name : 'ว่าง'; ?>
                            </span>
                            <span class="font-p-detail "><?= $rs->p_learder_rank; ?></span>
                            <?php if (!empty($rs->p_learder_phone)) : ?>
                                <span class="font-p-detail">เบอร์ <?= $rs->p_learder_phone; ?></span>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                <?php } ?>
            ...
            <!-- <?php foreach ($rsOne as $rs) { ?>
                    <div class="bg-personnel-s">
                        <div class="rounded-image-s">
                            <img src="<?= base_url('docs/img/' . $rs->p_learder_img); ?>" width="100%" height="100%">
                        </div>
                    </div>
                    <div class="mt-3 center-center">
                        <span class="font-p-name"><?= $rs->p_learder_name; ?></span>
                        <span class="font-p-detail "><?= $rs->p_learder_rank; ?></span>
                        <?php if (!empty($rs->p_learder_phone)) : ?>
                            <span class="font-p-detail">เบอร์ <?= $rs->p_learder_phone; ?></span>
                        <?php endif; ?>
