            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/operation_rpf_detail/' . $rs->operation_rpf_id); ?>">
                            <?php if (!empty($rs->operation_rpf_img)) : ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->operation_rpf_img); ?>" width="94px" height="63px">
                            <?php else : ?>
                    ...
                    <div class="col-9 font-pages-content">
                        <a href="<?php echo site_url('Pages/operation_rpf_detail/' . $rs->operation_rpf_id); ?>">
                            <span class="one-line-ellipsis"><?= $rs->operation_rpf_name; ?></span>
                        </a>
                    </div>
                    <div class="col-2 span-time-pages-news">
                        <a href="<?php echo site_url('Pages/operation_rpf_detail/' . $rs->operation_rpf_id); ?>">
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" fill="currentColor" class="bi bi-calendar-minus-fill" viewBox="0 0 16 16">
                                ...
                                $date = new DateTime($rs->operation_rpf_date);
