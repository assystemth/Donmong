            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/plan_lad_detail/' . $rs->plan_lad_id); ?>">
                            <?php if (!empty($rs->plan_lad_img)): ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->plan_lad_img); ?>"
                    ...
                    <div class="col-2 span-time-pages-news">
                        <a href="<?php echo site_url('Pages/plan_lad_detail/' . $rs->plan_lad_id); ?>">
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" fill="currentColor"
                                ...
                                $date = new DateTime($rs->plan_lad_date);
